...
{
public:
	FPointer                                           Socket;                                           		// 0x0284 (0x0008) [0x0000000000000002]              ( CPF_Const )
	FPointer                                           RemoteSocket;                                     		// 0x028C (0x0008) [0x0000000000000002]              ( CPF_Const )
	FPointer                                           PrivateResolveInfo;                               		// 0x0294 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                Port;                                             		// 0x029C (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                DataPending;                                      		// 0x02A0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      LinkMode;                                         		// 0x02A4 (0x0001) [0x0000000000000000]              
	unsigned char                                      InLineMode;                                       		// 0x02A5 (0x0001) [0x0000000000000000]              
	unsigned char                                      OutLineMode;                                      		// 0x02A6 (0x0001) [0x0000000000000000]              
	unsigned char                                      ReceiveMode;                                      		// 0x02A7 (0x0001) [0x0000000000000000]              
...
{
public:
	TArray<unsigned char>                              SendFIFO;                                         		// 0x02A8 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	FString                                            RecvBuf;                                          		// 0x02B8 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	class UClass*                                      AcceptClass;                                      		// 0x02C8 (0x0008) [0x0000000000000000]              
	struct FIpAddr                                     RemoteAddr;                                       		// 0x02D0 (0x0014) [0x0000000000000000]              
	unsigned char                                      LinkState;                                        		// 0x02E4 (0x0001) [0x0000000000000000]              
...
public:
	FPointer                                           VfTable_FTickableObject;                          		// 0x0060 (0x0008) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	FPointer                                           Socket;                                           		// 0x0068 (0x0008) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	struct SFXName                                     BeaconName;                                       		// 0x0070 (0x0008) [0x0000000000000000]              
...
public:
	...
	FPointer                                           Socket;                                           		// 0x0078 (0x0008) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
...
{
public:
	FString                                            Applications[ 0xA ];                              		// 0x02E8 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            ApplicationPaths[ 0xA ];                          		// 0x0388 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            ServerName;                                       		// 0x0428 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            ServerURL;                                        		// 0x0438 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x0448 (0x0050) [0x0000000000000000]              
	int                                                ListenPort;                                       		// 0x0498 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxConnections;                                   		// 0x049C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                DefaultApplication;                               		// 0x04A0 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ExpirationSeconds;                                		// 0x04A4 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnectionCount;                                  		// 0x04A8 (0x0004) [0x0000000000000000]              
	int                                                ConnId;                                           		// 0x04AC (0x0004) [0x0000000000000000]              
	unsigned long                                      bEnabled : 1;                                     		// 0x04B0 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
...
{
public:
	FString                                            ReceivedData;                                     		// 0x02E8 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class AWebServer*                                  WebServer;                                        		// 0x02F8 (0x0008) [0x0000000000000000]              
	class UWebRequest*                                 Request;                                          		// 0x0300 (0x0008) [0x0000000000000000]              
	class UWebResponse*                                Response;                                         		// 0x0308 (0x0008) [0x0000000000000000]              
	class UWebApplication*                             Application;                                      		// 0x0310 (0x0008) [0x0000000000000000]              
	int                                                RawBytesExpecting;                                		// 0x0318 (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x031C (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x0320 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnId;                                           		// 0x0324 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDelayCleanup : 1;                                		// 0x0328 (0x0004) [0x0000000000000000] [0x00000001] 
