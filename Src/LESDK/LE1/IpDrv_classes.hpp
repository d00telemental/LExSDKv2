...
{
public:
	class TArray<unsigned char>                        SendFIFO;                                         		// 0x02A8 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	class FString                                      RecvBuf;                                          		// 0x02B8 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	class FString                                      ServerName;                                       		// 0x0428 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	class FString                                      ReceivedData;                                     		// 0x02E8 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
