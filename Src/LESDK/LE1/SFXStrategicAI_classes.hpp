...
# ========================================================================================= #
# File: SFXStrategicAI_classes.hpp
# ========================================================================================= #
...
public:
	...
	void eventOnCastAt ( class APawn* oMember, class APawn* oAttacker, struct SFXName nmPower );
	void eventOnAttacked ( class APawn* oMember, class APawn* oAttacker, struct SFXName nmWeapon );
	void eventMemberActionComplete_Combat ( class ABioPawn* Who, struct SFXName Action, struct SFXName nmTechnique, int nReason, class AActor* oLastTarget, float fReqStability, float fAbortStability, float fReqRadius, float fLastTimeOut );
