...
public:
	...
	int GetNetIndex ( );
	void appScreenWarningMessage ( FString const& sMsg );
	...
	bool PointInBox ( struct FVector const& Point, struct FVector const& Location, struct FVector const& Extent );
	...
	class UObject* DynamicLoadDefaultResource ( FString const& sIniKey, class UClass* ExpectedClass );
	bool GetIniArray ( FString const& sFile, FString const& sSection, FString const& sKey, TArray<FString>* aResult );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x7FF79AF4FBA0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x7FF79AEC8C50 (0x08)
	virtual void VirtualFunction02 ( );																			// 0x7FF79AEB4690 (0x10)
	virtual void VirtualFunction03 ( );																			// 0x7FF79AEB4690 (0x18)
	virtual void VirtualFunction04 ( );																			// 0x7FF79AFB6A70 (0x20)
	virtual void VirtualFunction05 ( );																			// 0x7FF79AFBA060 (0x28)
	virtual void VirtualFunction06 ( );																			// 0x7FF79AF5A4B0 (0x30)
	virtual void VirtualFunction07 ( );																			// 0x7FF79AFAD840 (0x38)
	virtual void VirtualFunction08 ( );																			// 0x7FF79AFB7020 (0x40)
	virtual void VirtualFunction09 ( );																			// 0x7FF79AEB4690 (0x48)
	virtual void VirtualFunction10 ( );																			// 0x7FF79AEB4690 (0x50)
	virtual void VirtualFunction11 ( );																			// 0x7FF79AFACB10 (0x58)
	virtual void VirtualFunction12 ( );																			// 0x7FF79AEC8C50 (0x60)
	virtual void VirtualFunction13 ( );																			// 0x7FF79AFBBA40 (0x68)
	virtual void VirtualFunction14 ( );																			// 0x7FF79AF544F0 (0x70)
	virtual void VirtualFunction15 ( );																			// 0x7FF79AF5C500 (0x78)
	virtual void VirtualFunction16 ( );																			// 0x7FF79AFBB2C0 (0x80)
	virtual void VirtualFunction17 ( );																			// 0x7FF79AEC9F10 (0x88)
	virtual void VirtualFunction18 ( );																			// 0x7FF79AEB4690 (0x90)
	virtual void VirtualFunction19 ( );																			// 0x7FF79AEB4690 (0x98)
	virtual void VirtualFunction20 ( );																			// 0x7FF79AFB70A0 (0xA0)
	virtual void VirtualFunction21 ( );																			// 0x7FF79AFB7100 (0xA8)
	virtual void VirtualFunction22 ( );																			// 0x7FF79AFB6F90 (0xB0)
	virtual void VirtualFunction23 ( );																			// 0x7FF79AFB6FF0 (0xB8)
	virtual void VirtualFunction24 ( );																			// 0x7FF79AFACF90 (0xC0)
	virtual void VirtualFunction25 ( );																			// 0x7FF79AFB7110 (0xC8)
	virtual void VirtualFunction26 ( );																			// 0x7FF79AFB7010 (0xD0)
	virtual void VirtualFunction27 ( );																			// 0x7FF79AEB4690 (0xD8)
	virtual void VirtualFunction28 ( );																			// 0x7FF79AEB4690 (0xE0)
	virtual void VirtualFunction29 ( );																			// 0x7FF79AFC1C50 (0xE8)
	virtual void VirtualFunction30 ( );																			// 0x7FF79AFB7110 (0xF0)
	virtual void VirtualFunction31 ( );																			// 0x7FF79AFB7010 (0xF8)
	virtual void VirtualFunction32 ( );																			// 0x7FF79AFB7110 (0x100)
	virtual void VirtualFunction33 ( );																			// 0x7FF79AFB7010 (0x108)
	virtual void VirtualFunction34 ( );																			// 0x7FF79AFB0580 (0x110)
	virtual void VirtualFunction35 ( );																			// 0x7FF79AFB9EA0 (0x118)
	virtual void VirtualFunction36 ( );																			// 0x7FF79AFB54E0 (0x120)
	virtual void VirtualFunction37 ( );																			// 0x7FF79AEB4690 (0x128)
	virtual void VirtualFunction38 ( );																			// 0x7FF79AF5AB40 (0x130)
	virtual void VirtualFunction39 ( );																			// 0x7FF79AFB3C80 (0x138)
	virtual void VirtualFunction40 ( );																			// 0x7FF79AECAAE0 (0x140)
	virtual void VirtualFunction41 ( );																			// 0x7FF79AECAB00 (0x148)
	virtual void VirtualFunction42 ( );																			// 0x7FF79AECAAF0 (0x150)
	virtual void VirtualFunction43 ( );																			// 0x7FF79AEC88E0 (0x158)
	virtual void VirtualFunction44 ( );																			// 0x7FF79AEC8830 (0x160)
	virtual void VirtualFunction45 ( );																			// 0x7FF79AEC3750 (0x168)
	virtual void VirtualFunction46 ( );																			// 0x7FF79AEB4690 (0x170)
	virtual void VirtualFunction47 ( );																			// 0x7FF79AEB4690 (0x178)
	virtual void VirtualFunction48 ( );																			// 0x7FF79AEB4690 (0x180)
	virtual void VirtualFunction49 ( );																			// 0x7FF79B337350 (0x188)
	virtual void VirtualFunction50 ( );																			// 0x7FF79B3378A0 (0x190)
	virtual void VirtualFunction51 ( );																			// 0x7FF79AFB7B50 (0x198)
	virtual void VirtualFunction52 ( );																			// 0x7FF79AF53EB0 (0x1A0)
	virtual void VirtualFunction53 ( );																			// 0x7FF79AEB4690 (0x1A8)
	virtual void VirtualFunction54 ( );																			// 0x7FF79AEB4690 (0x1B0)
	virtual void VirtualFunction55 ( );																			// 0x7FF79AEB4690 (0x1B8)
	virtual void VirtualFunction56 ( );																			// 0x7FF79AEC88E0 (0x1C0)
	virtual void VirtualFunction57 ( );																			// 0x7FF79AFB0C40 (0x1C8)
	virtual void VirtualFunction58 ( );																			// 0x7FF79AEC3750 (0x1D0)
	virtual void VirtualFunction59 ( );																			// 0x7FF79AFB3C30 (0x1D8)
	virtual void VirtualFunction60 ( );																			// 0x7FF79AEC4480 (0x1E0)
	virtual void VirtualFunction61 ( );																			// 0x7FF79AFC1840 (0x1E8)
	virtual void VirtualFunction62 ( );																			// 0x7FF79AEB4690 (0x1F0)
	virtual void VirtualFunction63 ( );																			// 0x7FF79AEB4690 (0x1F8)
	virtual void VirtualFunction64 ( );																			// 0x7FF79AEC3750 (0x200)
	virtual void VirtualFunction65 ( );																			// 0x7FF79AEC3750 (0x208)
	virtual void VirtualFunction66 ( );																			// 0x7FF79AEC3750 (0x210)
	virtual void VirtualFunction67 ( );																			// 0x7FF79AFB0E10 (0x218)
	virtual void VirtualFunction68 ( );																			// 0x7FF79AEC88A0 (0x220)
	virtual void VirtualFunction69 ( );																			// 0x7FF79AEC9F00 (0x228)
	virtual void VirtualFunction70 ( );																			// 0x7FF79AECAAB0 (0x230)
	virtual void VirtualFunction71 ( );																			// 0x7FF79AFB3A80 (0x238)
	virtual void VirtualFunction72 ( );																			// 0x7FF79AFBB670 (0x240)
	virtual void VirtualFunction73 ( );																			// 0x7FF79AF51800 (0x248)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x7FF79AF7DD20 (0x250)
};
...
public:
	...
	TArray<FString>                                    CutdownPaths;                                     		// 0x00FC (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray<struct SFXName>                             Suppress;                                         		// 0x010C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray<FString>                                    Extensions;                                       		// 0x011C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray<FString>                                    SeekFreePCExtensions;                             		// 0x012C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray<FString>                                    LocalizationPaths;                                		// 0x013C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            TextureFileCacheExtension;                        		// 0x014C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	TArray<struct FBioDlgToken>                        Tokens;                                           		// 0x0060 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	bool eventGetStringToken ( int nActionCode, FString* sToken );
};
...
{
public:
	FString                                            OwnerName;                                        		// 0x0060 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
