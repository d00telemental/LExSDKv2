...
{
	FPointer                                           Node;                                             		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
{
	FPointer                                           Data;                                             		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
{
	FPointer                                           VfTable;                                          		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	FPointer                                           VertexData;                                       		// 0x0008 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
struct FUntypedBulkData_Mirror
{
	...
	FPointer                                           BulkData;                                         		// 0x0028 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                LockStatus;                                       		// 0x0030 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	FPointer                                           AttachedAr;                                       		// 0x0034 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
{
	FPointer                                           IndirectData;                                     		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
struct FSet_Mirror
{
	...
	FPointer                                           Hash;                                             		// 0x003C (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
