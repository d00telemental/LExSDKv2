...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x7FF780EE5BC0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x7FF780F23530 (0x08)
	virtual void VirtualFunction02 ( );																			// 0x7FF780F1BC20 (0x10)
	virtual void VirtualFunction03 ( );																			// 0x7FF780EE5BC0 (0x18)
	virtual void VirtualFunction04 ( );																			// 0x7FF780ECD1E0 (0x20)
	virtual void VirtualFunction05 ( );																			// 0x7FF780ECD1E0 (0x28)
	virtual void VirtualFunction06 ( );																			// 0x7FF780F7FA10 (0x30)
	virtual void VirtualFunction07 ( );																			// 0x7FF780F83240 (0x38)
	virtual void VirtualFunction08 ( );																			// 0x7FF780F26AF0 (0x40)
	virtual void VirtualFunction09 ( );																			// 0x7FF780ECD1E0 (0x48)
	virtual void VirtualFunction10 ( );																			// 0x7FF780F80100 (0x50)
	virtual void VirtualFunction11 ( );																			// 0x7FF780ECD1E0 (0x58)
	virtual void VirtualFunction12 ( );																			// 0x7FF780ECD1E0 (0x60)
	virtual void VirtualFunction13 ( );																			// 0x7FF780F75900 (0x68)
	virtual void VirtualFunction14 ( );																			// 0x7FF780EE5BC0 (0x70)
	virtual void VirtualFunction15 ( );																			// 0x7FF780F84B70 (0x78)
	virtual void VirtualFunction16 ( );																			// 0x7FF780F20630 (0x80)
	virtual void VirtualFunction17 ( );																			// 0x7FF780F28580 (0x88)
	virtual void VirtualFunction18 ( );																			// 0x7FF780F84490 (0x90)
	virtual void VirtualFunction19 ( );																			// 0x7FF780F0B080 (0x98)
	virtual void VirtualFunction20 ( );																			// 0x7FF780ECD1E0 (0xA0)
	virtual void VirtualFunction21 ( );																			// 0x7FF780ECD1E0 (0xA8)
	virtual void VirtualFunction22 ( );																			// 0x7FF780F80190 (0xB0)
	virtual void VirtualFunction23 ( );																			// 0x7FF780F801F0 (0xB8)
	virtual void VirtualFunction24 ( );																			// 0x7FF780F80070 (0xC0)
	virtual void VirtualFunction25 ( );																			// 0x7FF780F800D0 (0xC8)
	virtual void VirtualFunction26 ( );																			// 0x7FF780F75D80 (0xD0)
	virtual void VirtualFunction27 ( );																			// 0x7FF780F80200 (0xD8)
	virtual void VirtualFunction28 ( );																			// 0x7FF780F800F0 (0xE0)
	virtual void VirtualFunction29 ( );																			// 0x7FF780ECD1E0 (0xE8)
	virtual void VirtualFunction30 ( );																			// 0x7FF780ECD1E0 (0xF0)
	virtual void VirtualFunction31 ( );																			// 0x7FF780F8AF60 (0xF8)
	virtual void VirtualFunction32 ( );																			// 0x7FF780F80200 (0x100)
	virtual void VirtualFunction33 ( );																			// 0x7FF780F800F0 (0x108)
	virtual void VirtualFunction34 ( );																			// 0x7FF780F80200 (0x110)
	virtual void VirtualFunction35 ( );																			// 0x7FF780F800F0 (0x118)
	virtual void VirtualFunction36 ( );																			// 0x7FF780F79990 (0x120)
	virtual void VirtualFunction37 ( );																			// 0x7FF780F83080 (0x128)
	virtual void VirtualFunction38 ( );																			// 0x7FF780F7E480 (0x130)
	virtual void VirtualFunction39 ( );																			// 0x7FF780ECD1E0 (0x138)
	virtual void VirtualFunction40 ( );																			// 0x7FF780F27120 (0x140)
	virtual void VirtualFunction41 ( );																			// 0x7FF780F7CCC0 (0x148)
	virtual void VirtualFunction42 ( );																			// 0x7FF780EEACA0 (0x150)
	virtual void VirtualFunction43 ( );																			// 0x7FF780EEACD0 (0x158)
	virtual void VirtualFunction44 ( );																			// 0x7FF780EEACB0 (0x160)
	virtual void VirtualFunction45 ( );																			// 0x7FF780EE6B60 (0x168)
	virtual void VirtualFunction46 ( );																			// 0x7FF780EE6A80 (0x170)
	virtual void VirtualFunction47 ( );																			// 0x7FF780EDBC30 (0x178)
	virtual void VirtualFunction48 ( );																			// 0x7FF780ECD1E0 (0x180)
	virtual void VirtualFunction49 ( );																			// 0x7FF780ECD1E0 (0x188)
	virtual void VirtualFunction50 ( );																			// 0x7FF780ECD1E0 (0x190)
	virtual void VirtualFunction51 ( );																			// 0x7FF781560440 (0x198)
	virtual void VirtualFunction52 ( );																			// 0x7FF781560990 (0x1A0)
	virtual void VirtualFunction53 ( );																			// 0x7FF780F80CE0 (0x1A8)
	virtual void VirtualFunction54 ( );																			// 0x7FF780F20110 (0x1B0)
	virtual void VirtualFunction55 ( );																			// 0x7FF780ECD1E0 (0x1B8)
	virtual void VirtualFunction56 ( );																			// 0x7FF780ECD1E0 (0x1C0)
	virtual void VirtualFunction57 ( );																			// 0x7FF780ECD1E0 (0x1C8)
	virtual void VirtualFunction58 ( );																			// 0x7FF780F21950 (0x1D0)
	virtual void VirtualFunction59 ( );																			// 0x7FF780F79F10 (0x1D8)
	virtual void VirtualFunction60 ( );																			// 0x7FF780EDBC30 (0x1E0)
	virtual void VirtualFunction61 ( );																			// 0x7FF780F7CC70 (0x1E8)
	virtual void VirtualFunction62 ( );																			// 0x7FF780F087D0 (0x1F0)
	virtual void VirtualFunction63 ( );																			// 0x7FF780F8AB50 (0x1F8)
	virtual void VirtualFunction64 ( );																			// 0x7FF780ECD1E0 (0x200)
	virtual void VirtualFunction65 ( );																			// 0x7FF780EDBC30 (0x208)
	virtual void VirtualFunction66 ( );																			// 0x7FF780EE6B00 (0x210)
	virtual void VirtualFunction67 ( );																			// 0x7FF780EE9450 (0x218)
	virtual void VirtualFunction68 ( );																			// 0x7FF780EEA9F0 (0x220)
	virtual void VirtualFunction69 ( );																			// 0x7FF780F7CAA0 (0x228)
	virtual void VirtualFunction70 ( );																			// 0x7FF780F84840 (0x230)
	virtual void VirtualFunction71 ( );																			// 0x7FF780F1DA50 (0x238)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x7FF780F48D50 (0x240)
};
