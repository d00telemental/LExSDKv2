...
public:
	...
	struct FScriptDelegate                             __OnConnectionStatusChange__Delegate;             		// 0x0140 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnStorageDeviceChange__Delegate;                		// 0x0150 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnReadTitleFileComplete__Delegate;              		// 0x0160 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	class USFXOnlineEventList*                         EventList;                                        		// 0x02A8 (0x0008) [0x0000000000000000]              
	struct FScriptDelegate                             __OnEvent__Delegate;                              		// 0x02B0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	FPointer                                           VfTable_IISFXOnlineComponentPlatform;             		// 0x0094 (0x0008) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	FPointer                                           NotificationHandle;                               		// 0x009C (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	int                                                NumLogins;                                        		// 0x00A4 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      bIsInSignInUI : 1;                                		// 0x00A8 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
	unsigned long                                      bIsCountingDownSigninNotification : 1;            		// 0x00A8 (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	struct FCachedLoginState                           LastLoginState[ 0x4 ];                            		// 0x00AC (0x0050) [0x0000000000000002]              ( CPF_Const )
...
public:
	...
	unsigned long                                      PendingConnectCerberusRefused : 1;                		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      PendingConnectNucleusSuccessful : 1;              		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      PendingConnectProfileChanged : 1;                 		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      PendingConnectAccountCreation : 1;                		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      PendingConnectEAProducts : 1;                     		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000040] 
...
{
public:
	unsigned long                                      RedeemedProductCode : 1;                          		// 0x0174 (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	struct FScriptDelegate                             __CanCollect__Delegate;                           		// 0x0108 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnAuthenticate__Delegate;                       		// 0x0118 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnDisconnect__Delegate;                         		// 0x0128 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
