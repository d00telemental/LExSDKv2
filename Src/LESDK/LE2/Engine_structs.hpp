...
struct FPostProcessSettings
{
	...
	unsigned long                                      bEnableFilmicAlternateLUT : 1;                    		// 0x00D8 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bOverride_EnableVignette : 1;                     		// 0x00D8 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bEnableVignette : 1;                              		// 0x00D8 (0x0004) [0x0000000000000001] [0x00004000] ( CPF_Edit )
	unsigned long                                      bOverride_EnableFilmGrain : 1;                    		// 0x00D8 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bEnableFilmGrain : 1;                             		// 0x00D8 (0x0004) [0x0000000000000001] [0x00010000] ( CPF_Edit )
	unsigned long                                      MotionBlur_FullMotionBlur : 1;                    		// 0x00D8 (0x0004) [0x0000000000000001] [0x00020000] ( CPF_Edit )
...
struct FSFHandlerTemplate
{
	...
	unsigned long                                      bRequiresScaling : 1;                             		// 0x0040 (0x0004) [0x0000000000000000] [0x00000008] 
...
struct FBioScaleformResource
{
	...
	int                                                Dummy11;                                          		// 0x0040 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
};
...
struct FUIStringNode
{
	...
	class UUIDataStore*                                NodeDataStore;                                    		// 0x0008 (0x0008) [0x0000000000102002]              ( CPF_Const | CPF_Transient )
	FPointer                                           ParentNode;                                       		// 0x0010 (0x0008) [0x0000000000103002]              ( CPF_Const | CPF_Native | CPF_Transient )
	FString                                            SourceText;                                       		// 0x0018 (0x0010) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
...
struct FCoverSlot
{
	...
	int                                                ExtraCost;                                        		// 0x00DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LeanTraceDist;                                    		// 0x00E0 (0x0004) [0x0000000000000000]              
	unsigned long                                      bLeanLeft : 1;                                    		// 0x00E4 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bLeanRight : 1;                                   		// 0x00E4 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bForceCanPopUp : 1;                               		// 0x00E4 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bCanPopUp : 1;                                    		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000008] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanMantle : 1;                                   		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000010] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanClimbUp : 1;                                  		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000020] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bForceCanCoverSlip_Left : 1;                      		// 0x00E4 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned long                                      bForceCanCoverSlip_Right : 1;                     		// 0x00E4 (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      bCanCoverSlip_Left : 1;                           		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000100] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanCoverSlip_Right : 1;                          		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000200] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanSwatTurn_Left : 1;                            		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000400] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bCanSwatTurn_Right : 1;                           		// 0x00E4 (0x0004) [0x0000000000020001] [0x00000800] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bEnabled : 1;                                     		// 0x00E4 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bAllowPopup : 1;                                  		// 0x00E4 (0x0004) [0x0000000000000001] [0x00002000] ( CPF_Edit )
	unsigned long                                      bAllowMantle : 1;                                 		// 0x00E4 (0x0004) [0x0000000000000001] [0x00004000] ( CPF_Edit )
	unsigned long                                      bAllowCoverSlip : 1;                              		// 0x00E4 (0x0004) [0x0000000000000001] [0x00008000] ( CPF_Edit )
	unsigned long                                      bAllowClimbUp : 1;                                		// 0x00E4 (0x0004) [0x0000000000000001] [0x00010000] ( CPF_Edit )
	unsigned long                                      bAllowSwatTurn : 1;                               		// 0x00E4 (0x0004) [0x0000000000000001] [0x00020000] ( CPF_Edit )
	unsigned long                                      bForceNoGroundAdjust : 1;                         		// 0x00E4 (0x0004) [0x0000000000000001] [0x00040000] ( CPF_Edit )
	unsigned long                                      bPlayerOnly : 1;                                  		// 0x00E4 (0x0004) [0x0000000000000001] [0x00080000] ( CPF_Edit )
	unsigned long                                      bSelected : 1;                                    		// 0x00E4 (0x0004) [0x0000000000002000] [0x00100000] ( CPF_Transient )
	unsigned long                                      bFailedToFindSurface : 1;                         		// 0x00E4 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned char                                      ForceCoverType;                                   		// 0x00E8 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      CoverType;                                        		// 0x00E9 (0x0001) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	unsigned char                                      LocationDescription;                              		// 0x00EA (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray<struct FSubtitleCue>                        Subtitles;                                        		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FLensFlareElement
{
	...
	TArray<class UMaterialInterface*>                  LFMaterials;                                      		// 0x0168 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FVector                                     Size;                                             		// 0x0178 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     ElementName;                                      		// 0x0184 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
{
	TArray<struct FPhysXDestructibleDepthParameters>   DepthParameters;                                  		// 0x0000 (0x0010) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
...
struct FPhysXDestructibleChunk
{
	...
	FPointer                                           Structure;                                        		// 0x0080 (0x0008) [0x0000000000001000]              ( CPF_Native )
	...
	struct SFXName                                     BoneName;                                         		// 0x00A0 (0x0008) [0x0000000000000000]              
