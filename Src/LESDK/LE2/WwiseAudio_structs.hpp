...
{
	class TArray<class UWwiseStream*>                  Streams;                                          		// 0x0000 (0x0010) [0x0000000000420003]              ( CPF_Edit | CPF_Const | CPF_EditConst | CPF_NeedCtorLink )
	class UWwiseBank*                                  Bank;                                             		// 0x0010 (0x0008) [0x0000000000020003]              ( CPF_Edit | CPF_Const | CPF_EditConst )
};
...
{
	struct FWwiseRelationships                         Relationships;                                    		// 0x0000 (0x0018) [0x0000000000420003]              ( CPF_Edit | CPF_Const | CPF_EditConst | CPF_NeedCtorLink )
