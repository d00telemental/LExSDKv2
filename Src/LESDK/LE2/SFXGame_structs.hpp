...
{
	struct SFXName                                     sFeatureName;                                     		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FBioSEELocal : FBioStateEventElement
{
	...
	struct SFXName                                     ObjectTag;                                        		// 0x001C (0x0008) [0x0000000000100000]              
	struct SFXName                                     FunctionName;                                     		// 0x0024 (0x0008) [0x0000000000100000]              
};
...
{
	FPointer                                           VfTable;                                          		// 0x001C (0x0008) [0x0000000000803002]              ( CPF_Const | CPF_Native | CPF_Transient | CPF_NoExport )
...
struct FMemberData
{
	...
	struct SFXName                                     nmPower;                                          		// 0x0028 (0x0008) [0x0000000000000000]              
...
{
	struct SFXName                                     PowerName;                                        		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     PowerClassName;                                   		// 0x0008 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
struct FWeaponSaveRecord
{
	...
	struct SFXName                                     WeaponClassName;                                  		// 0x0024 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     AmmoPowerName;                                    		// 0x002C (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
struct FPlayerSaveRecord
{
	...
	struct SFXName                                     PlayerClassName;                                  		// 0x0208 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     MappedTalent;                                     		// 0x0210 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     MappedPower1;                                     		// 0x0218 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     MappedPower2;                                     		// 0x0220 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     MappedPower3;                                     		// 0x0228 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     PrimaryWeapon;                                    		// 0x0230 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     SecondaryWeapon;                                  		// 0x0238 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     LastPower;                                        		// 0x0240 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
struct FPowerSaveInfo
{
	...
	struct SFXName                                     PowerClassName;                                   		// 0x0008 (0x0008) [0x0000000000000000]              
...
struct FBodyStance
{
	struct SFXName                                     AnimName;                                         		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
{
	struct SFXName                                     HenchTag;                                         		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct SFXName                                     PackageName;                                      		// 0x0008 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FBioMeshPropActionData
{
	...
	struct SFXName                                     nmActionName;                                     		// 0x0034 (0x0008) [0x0000000000000000]              
	struct SFXName                                     nmAttachTo;                                       		// 0x003C (0x0008) [0x0000000000000000]              
...
struct FSFXNotification
{
	...
	struct SFXName                                     nmSound;                                          		// 0x0048 (0x0008) [0x0000000000000000]              
	struct SFXName                                     nmStopSound;                                      		// 0x0050 (0x0008) [0x0000000000000000]              
...
{
	struct SFXName                                     Trace[ 0xA ];                                     		// 0x0000 (0x0050) [0x0000000000000000]              
...
struct FBioMessageBoxData
{
	...
	struct SFXName                                     m_nmCallbackFunction;                             		// 0x0034 (0x0008) [0x0000000000000000]              
...
{
	struct SFXName                                     Tag;                                              		// 0x0000 (0x0008) [0x0000000000000000]              
	struct SFXName                                     LoadoutTag;                                       		// 0x0008 (0x0008) [0x0000000000000000]              
	struct SFXName                                     DiscoveredLabel;                                  		// 0x0010 (0x0008) [0x0000000000000000]              
	struct SFXName                                     AvailableLabel;                                   		// 0x0018 (0x0008) [0x0000000000000000]              
	struct SFXName                                     InPartyLabel;                                     		// 0x0020 (0x0008) [0x0000000000000000]              
	struct SFXName                                     IsLoyalLabel;                                     		// 0x0028 (0x0008) [0x0000000000000000]              
	struct SFXName                                     OldLoyaltyLabel;                                  		// 0x0030 (0x0008) [0x0000000000000000]              
	struct SFXName                                     AppearanceLabel;                                  		// 0x0038 (0x0008) [0x0000000000000000]              
...
struct FTechData
{
	...
	struct SFXName                                     PlotName;                                         		// 0x010C (0x0008) [0x0000000000000000]              
