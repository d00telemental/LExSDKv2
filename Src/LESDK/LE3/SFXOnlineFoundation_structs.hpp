...
struct FBWOfferInfo
{
	...
	class FString                                      sShortDescription;                                		// 0x0010 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class FString                                      sLongDescription;                                 		// 0x0020 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class FString                                      sPrice;                                           		// 0x0030 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      sKey;                                             		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class FString                                      sName;                                            		// 0x0010 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class FString                                      sValue;                                           		// 0x0020 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	class TArray<struct FBWEntitlementToken>           sTokens;                                          		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      SourceName;                                       		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      param1;                                           		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      param2;                                           		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      param3;                                           		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      Value;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FMPDLCInfo
{
	class TArray<class FString>                        MapPackageNames;                                  		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      FriendPersonaName;                                		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      Heading;                                          		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      sMetaData;                                        		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      HeaderMovieClip;                                  		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      RowEntryMovieClip;                                		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FLeaderboardRecord
{
	...
	class TArray<class FString>                        sRecordData;                                      		// 0x0008 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      KeyScope;                                         		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class TArray<struct FLeaderboardStatScopeValuePair> KeyScopePairs;                                    		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	class FString                                      LocalizationKey;                                  		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      sPrettyName;                                      		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      MapName;                                          		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class TArray<struct FLeaderboardDefinition>        Entries;                                          		// 0x0010 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	class FString                                      sEntityName;                                      		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
struct FSFXOnlineEntitlementLookupInfo
{
	...
	class FString                                      sGroupName;                                       		// 0x0014 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class FString                                      sEntitlementName;                                 		// 0x0024 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class FString                                      sProductId;                                       		// 0x0034 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FInviteData
{
	class TArray<struct FScriptDelegate>               InviteDelegates;                                  		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	class FString                                      sLbName;                                          		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      KeyScope;                                         		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class TArray<struct FQWord>                        StartKeyScopeValue;                               		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class TArray<struct FQWord>                        EndKeyScopeValue;                                 		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	class FString                                      sPreviousFriendRankBlob;                          		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class TArray<struct FLeaderboardRecord>            aRankResults;                                     		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      email;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class TArray<class FString>                        Params;                                           		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      mImageName;                                       		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FPCFriend
{
	...
	class FString                                      FriendName;                                       		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      AvatarID;                                         		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      Title;                                            		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      TitleId;                                          		// 0x0040 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      Group;                                            		// 0x0050 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      Image;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	class FString                                      Image;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class FString                                      WaveClass;                                        		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FHTTPParameter
{
	...
	class FString                                      mValue;                                           		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
