...
{
	struct SFXName                                     ItemName;                                         		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	class FString                                      Level;                                            		// 0x0008 (0x0010) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	...
	// class FString                                   S;                                                		// 0x00A0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct SFXName                                  N;                                                		// 0x00B0 (0x0008) [0x0000000000000000]              
};
...
struct ASFXGameInfoSP_execAwardCredits_Parms
{
	...
	class FString                                      Level;                                            		// 0x0004 (0x0010) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
...
struct ASFXGameInfoSP_execFindPlayerStart_Parms
{
	...
	// struct SFXName                                  ATStart;                                          		// 0x002C (0x0008) [0x0000000000000000]              
...
struct ASFXWeapon_Heavy_Beam_Base_execPreCalculateAdjustedAim_Parms
{
	...
	// struct FVector                                  StartFireLoc;                                     		// 0x0004 (0x000C) [0x0000000000000000]              
	// struct FRotator                                 rTargetAim;                                       		// 0x0010 (0x000C) [0x0000000000000000]              
	// struct FRotator                                 rCurrentAim;                                      		// 0x001C (0x000C) [0x0000000000000000]              
...
struct ASFXWeapon_Heavy_Beam_Base_execProcessInstantHit_Parms
{
	...
	struct FImpactInfo                                 Impact;                                           		// 0x0004 (0x0064) [0x0000000000000080]              ( CPF_Parm )
...
struct ASFXWeapon_Heavy_Beam_Base_execCalcFireStart_Parms
{
	...
	// struct FVector                                  FireDir;                                          		// 0x000C (0x000C) [0x0000000000000000]              
	// struct FVector                                  TargetLatVel;                                     		// 0x0018 (0x000C) [0x0000000000000000]              
	// struct FVector                                  ToTarget;                                         		// 0x0024 (0x000C) [0x0000000000000000]              
	...
	// struct FVector                                  TargetLoc;                                        		// 0x0044 (0x000C) [0x0000000000000000]              
};
...
struct ASFXWeapon_Heavy_Beam_Base_execStretchDecal_Parms
{
	...
	// struct FVector                                  Stretch;                                          		// 0x0074 (0x000C) [0x0000000000000000]              
	// float                                           Rot;                                              		// 0x0080 (0x0004) [0x0000000000000000]              
	// float                                           StretchFactor;                                    		// 0x0084 (0x0004) [0x0000000000000000]              
	// struct FRotator                                 NormRot;                                          		// 0x0088 (0x000C) [0x0000000000000000]              
...
{
	class TArray<struct SFXName>                       UsedAnims;                                        		// 0x0000 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	struct SFXName                                     Parameter;                                        		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
...
struct USFXPowerCustomAction_Shockwave_execShouldUsePower_Parms
{
	...
	class FString                                      sOptionalInfo;                                    		// 0x0008 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned long                                      ReturnValue;                                      		// 0x0018 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
...
struct USFXPowerCustomAction_Shockwave_execDoImpact_Parms
{
	...
	// class TArray<class AActor*>                     NearbyActors;                                     		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct USFXPowerCustomAction_Shockwave_execReleaseProjectilePower_Parms
{
	...
	// class TArray<class AActor*>                     NearbyActors;                                     		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct USFXPowerCustomAction_BioticGrenade_execSpawnChildProjectiles_Parms
{
	...
	// struct FVector                                  AttachPoint;                                      		// 0x000C (0x000C) [0x0000000000000000]              
...
{
	// class TArray<class AActor*>                     NearbyActors;                                     		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct USFXPowerCustomAction_Warp_execPlayImpactEffects_Parms
{
	class AActor*                                      oImpacted;                                        		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     ImpactLocation;                                   		// 0x0008 (0x000C) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     ImpactNormal;                                     		// 0x0014 (0x000C) [0x0000000000000080]              ( CPF_Parm )
};
...
struct USFXPowerCustomAction_Warp_execOnImpact_Parms
{
	...
	// struct FVector                                  Param;                                            		// 0x0068 (0x000C) [0x0000000000000000]              
...
{
	// struct FVector                                  vParams;                                          		// 0x0000 (0x000C) [0x0000000000000000]              
...
struct USFXPowerCustomAction_Singularity_execImpactNewTarget_Parms
{
	...
	// struct FVector                                  VParam;                                           		// 0x002C (0x000C) [0x0000000000000000]              
	// struct FVector                                  vForce;                                           		// 0x0038 (0x000C) [0x0000000000000000]              
...
struct USFXPowerCustomAction_Singularity_eventTickCustomAction_Parms
{
	...
	// class TArray<class AActor*>                     NearbyActors;                                     		// 0x000C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	// struct FVector                                  vForce;                                           		// 0x0044 (0x000C) [0x0000000000000000]              
	// struct FVector                                  vHitNormal;                                       		// 0x0050 (0x000C) [0x0000000000000000]              
};
...
struct USFXPowerCustomAction_Singularity_execOnPowerDetonated_Parms
{
	...
	class ASFXProjectile_PowerCustomAction*            oProjectile;                                      		// 0x0018 (0x0008) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	class AActor*                                      HitActor;                                         		// 0x0020 (0x0008) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	// struct FVector                                  ProjectileVelocity;                               		// 0x0028 (0x000C) [0x0000000000000000]              
};
...
struct USFXGameEffect_PowerCombo_Fire_execOnImpact_Parms
{
	...
	// struct SFXName                                  BoneName;                                         		// 0x004C (0x0008) [0x0000000000000000]              
...
{
	float                                              DeltaSeconds;                                     		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// struct FVector                                  LinearForce;                                      		// 0x0004 (0x000C) [0x0000000000000000]              
	// struct FVector                                  AngularForce;                                     		// 0x0010 (0x000C) [0x0000000000000000]              
};
...
struct USFXGameEffect_Stasis_execStartCrustVFX_Parms
{
	...
	// struct FRvrClientEffectTarget                   Target;                                           		// 0x0008 (0x007C) [0x0000000000000000]              
};
...
struct USFXPowerCustomAction_Stasis_execImpactPushAway_Parms
{
	...
	// struct FVector                                  vForce;                                           		// 0x000C (0x000C) [0x0000000000000000]              
...
{
	// struct FVector                                  VParam;                                           		// 0x0000 (0x000C) [0x0000000000000000]              
	// class URvrClientEffectManager*                  Manager;                                          		// 0x000C (0x0008) [0x0000000000000000]              
};
...
{
	struct SFXName                                     VarName;                                          		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
};
...
struct ASFXProjectile_PowerCustomAction_Seeking_execPawnEvadedPower_Parms
{
	...
	struct SFXName                                     Label;                                            		// 0x0008 (0x0008) [0x0000000000000080]              ( CPF_Parm )
...
struct ASFXAI_Trooper_execDrawDifficulty_Parms
{
	...
	// struct SFXName                                  ParamName;                                        		// 0x0010 (0x0008) [0x0000000000000000]              
	// struct SFXName                                  CategoryName;                                     		// 0x0018 (0x0008) [0x0000000000000000]              
...
{
	struct SFXName                                     Label;                                            		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
...
struct USFXCustomAction_DeathReaction_GibHeadshot_execActivateImpactEmitter_Parms
{
	struct FVector                                     HitLocation;                                      		// 0x0000 (0x000C) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     HitNormal;                                        		// 0x000C (0x000C) [0x0000000000000080]              ( CPF_Parm )
	struct SFXName                                     BoneName;                                         		// 0x0018 (0x0008) [0x0000000000000080]              ( CPF_Parm )
...
{
	// class TArray<class AActor*>                     NearbyActors;                                     		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FAreaEffectParameters                    Param;                                            		// 0x0010 (0x0020) [0x0000000000000000]              
...
struct USFXPowerCustomAction_Reave_execOnImpact_Parms
{
	...
	// struct FRvrClientEffectTarget                   CETarget;                                         		// 0x0044 (0x007C) [0x0000000000000000]              
};
...
{
	class ABioPawn*                                    oPawn;                                            		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	// class TArray<class AActor*>                     NearbyActors;                                     		// 0x0008 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	// struct FVector                                  Params;                                           		// 0x0034 (0x000C) [0x0000000000000000]              
	// float                                           fDamage;                                          		// 0x0040 (0x0004) [0x0000000000000000]              
	// struct FVector                                  vForce;                                           		// 0x0044 (0x000C) [0x0000000000000000]              
...
struct USFXPowerCustomAction_CryoBlast_execApplySlowdownEffect_Parms
{
	...
	// class USFXModule_GameEffectManager*             Manager;                                          		// 0x000C (0x0008) [0x0000000000000000]              
	// struct FRvrClientEffectTarget                   TargetInfo;                                       		// 0x0014 (0x007C) [0x0000000000000000]              
...
struct USFXPowerCustomAction_Carnage_execOnImpact_Parms
{
	...
	// struct FVector                                  Param;                                            		// 0x0050 (0x000C) [0x0000000000000000]              
};
...
struct USFXGUI_ShotgunReticle_eventResetReticle_Parms
{
	...
	// struct FASDisplayInfo                           disp;                                             		// 0x0004 (0x002C) [0x0000000000000000]              
};
