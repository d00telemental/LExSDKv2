...
struct Usfxseqact_leavemission_execGrantAutomaticGawAssets_Parms
{
	...
	// class FString                                   MissionName;                                      		// 0x0064 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct Usfxseqact_leavemission_eventActivated_Parms
{
	...
	// class FString                                   CurrentMap;                                       		// 0x000C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	// struct SFXName                                  AchievementMapCode;                               		// 0x0060 (0x0008) [0x0000000000000000]              
	// class TArray<struct FTelemetryAttribute>        aTelAttribs;                                      		// 0x0068 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
