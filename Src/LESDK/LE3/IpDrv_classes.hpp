...
{
public:
	TArray<unsigned char>                              SendFIFO;                                         		// 0x0294 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	FString                                            RecvBuf;                                          		// 0x02A4 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
{
public:
	FString                                            Applications[ 0xA ];                              		// 0x02D4 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            ApplicationPaths[ 0xA ];                          		// 0x0374 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            ServerName;                                       		// 0x0414 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	FString                                            ServerURL;                                        		// 0x0424 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	FString                                            ReceivedData;                                     		// 0x02D4 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
