...
{
public:
	FPointer                                           Socket;                                           		// 0x0270 (0x0008) [0x0000000000000002]              ( CPF_Const )
	FPointer                                           RemoteSocket;                                     		// 0x0278 (0x0008) [0x0000000000000002]              ( CPF_Const )
	FPointer                                           PrivateResolveInfo;                               		// 0x0280 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
{
public:
	class TArray<unsigned char>                        SendFIFO;                                         		// 0x0294 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	class FString                                      RecvBuf;                                          		// 0x02A4 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
{
public:
	FPointer                                           VoiceEngine;                                      		// 0x0144 (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
...
public:
	...
	FPointer                                           LanBeacon;                                        		// 0x01B0 (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	FPointer                                           SessionInfo;                                      		// 0x01B8 (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
...
{
public:
	class FString                                      Applications[ 0xA ];                              		// 0x02D4 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	class FString                                      ApplicationPaths[ 0xA ];                          		// 0x0374 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	class FString                                      ServerName;                                       		// 0x0414 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	class FString                                      ServerURL;                                        		// 0x0424 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	class FString                                      ReceivedData;                                     		// 0x02D4 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
