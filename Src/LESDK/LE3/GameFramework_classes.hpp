...
public:
	...
	struct SFXName                                     ChildStatus;                                      		// 0x0068 (0x0008) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	class AGameAIController*                           GameAIOwner;                                      		// 0x0070 (0x0008) [0x0000000000002000]              ( CPF_Transient )
	struct SFXName                                     Status;                                           		// 0x0078 (0x0008) [0x0000000000002000]              ( CPF_Transient )
