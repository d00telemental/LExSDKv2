...
struct AWwiseAmbientSound_execHideEmitter_Parms
{
	 ...
	 AWwiseAmbientSound_execHideEmitter_Parms() { memset(this, 0, sizeof *this); }
	~AWwiseAmbientSound_execHideEmitter_Parms() {}
};
...
struct AWwiseAmbientSound_execDrawEmitter_Parms
{
	 ...
	 AWwiseAmbientSound_execDrawEmitter_Parms() { memset(this, 0, sizeof *this); }
	~AWwiseAmbientSound_execDrawEmitter_Parms() {}
};
...
struct UWwiseAudioComponent_execSetDrawMic_Parms
{
	unsigned long                                      bDraw;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	 ...
	 UWwiseAudioComponent_execSetDrawMic_Parms() { memset(this, 0, sizeof *this); }
	~UWwiseAudioComponent_execSetDrawMic_Parms() {}
};
...
struct UWwiseAudioComponent_execKillSound_Parms
{
	...
	unsigned long                                      ReturnValue;                                      		// 0x0008 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	 ...
	 UWwiseAudioComponent_execKillSound_Parms() { memset(this, 0, sizeof *this); }
	~UWwiseAudioComponent_execKillSound_Parms() {}
};
...
struct UWwiseAudioComponent_execStaticPostGlobalEventFromScript_Parms
{
	...
	unsigned long                                      ReturnValue;                                      		// 0x0008 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	 ...
	 UWwiseAudioComponent_execStaticPostGlobalEventFromScript_Parms() { memset(this, 0, sizeof *this); }
	~UWwiseAudioComponent_execStaticPostGlobalEventFromScript_Parms() {}
};
...
struct UWwiseProcFoleyComponent_eventGetMAX_PROC_FOLEY_BONES_Parms
{
	int                                                ReturnValue;                                      		// 0x0000 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	 ...
	 UWwiseProcFoleyComponent_eventGetMAX_PROC_FOLEY_BONES_Parms() { memset(this, 0, sizeof *this); }
	~UWwiseProcFoleyComponent_eventGetMAX_PROC_FOLEY_BONES_Parms() {}
};
...
struct AWwiseAudioVolume_execHideVolume_Parms
{
	 ...
	 AWwiseAudioVolume_execHideVolume_Parms() { memset(this, 0, sizeof *this); }
	~AWwiseAudioVolume_execHideVolume_Parms() {}
};
...
struct AWwiseAudioVolume_execDrawVolume_Parms
{
	 ...
	 AWwiseAudioVolume_execDrawVolume_Parms() { memset(this, 0, sizeof *this); }
	~AWwiseAudioVolume_execDrawVolume_Parms() {}
};
