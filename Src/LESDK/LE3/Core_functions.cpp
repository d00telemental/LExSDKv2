...
void UObject::appScreenDebugMessageStatic ( class FString sMsg )
{
...
// class TArray<class UObject*>   out_ObjectResults              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )

class TArray<class UObject*> UObject::GetObjectArrayFromConfigSection ( class UClass* SearchClass, unsigned long SearchChildren, class UObject* ResultOuter, class TArray<class UObject*>* out_ObjectResults )
{
...
// class TArray<struct FSFXTokenMapping> TokenList                      ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )

class FString UObject::GetTokenisedString ( int srStringID, class TArray<struct FSFXTokenMapping> TokenList )
{
